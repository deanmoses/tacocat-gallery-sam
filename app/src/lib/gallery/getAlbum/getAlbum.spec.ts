...
// Handed to the mocks as a copy: getAlbumAndChildren() writes next and prev
// onto the item it is given, and a shared object would carry them into
// whichever test runs after
