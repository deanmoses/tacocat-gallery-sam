...
describe('albumExists()', () => {
    ...
    it("Album doesn't exist in DynamoDB", async () => {
        // Mock out the AWS method
        mockDocClient.on(GetCommand).resolves({});
    ...
    it('Published album should exist for guest', async () => {
        // Mock out the AWS method
    ...
    it('Unpublished album should not exist for guest', async () => {
        // Mock out the AWS method
    ...
    it('Unpublished album should exist for admin', async () => {
        // Mock out the AWS method
        mockDocClient.on(GetCommand).resolves({ Item: { itemName: '2001' } });
...
describe('mediaExists()', () => {
    ...
    it("Image doesn't exist in DynamoDB", async () => {
        // Mock out the AWS method
        mockDocClient.on(GetCommand).resolves({});
    ...
    it('Image in published album should exist for guest', async () => {
        // Mock out the AWS method
        mockDocClient.on(GetCommand).resolves({ Item: { published: true } });
        const result = await mediaExists('/2001/12-31/image.jpg');
        expect(result).toBe(true);
    ...
    it('Image in unpublished album should not exist for guest', async () => {
        // Mock out the AWS method
    ...
    it('Image in unpublished album should exist for admin', async () => {
        // Mock out the AWS method
        mockDocClient.on(GetCommand).resolves({ Item: { itemName: 'image.jpg' } });
        const includeUnpublishedAlbums = true;
