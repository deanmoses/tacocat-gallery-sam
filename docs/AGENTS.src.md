...
- CloudFront for CDN delivery, and (staging-only prototype) an edge cache in front of the album API
...
- **syncAlbumVersions/**: direct invoke only, recomputes every album version (bootstrap or repair)
